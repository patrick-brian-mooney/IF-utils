#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A quick hack to help solve the pyramid puzzle in beta version 1.62 of Greg
...
solutions_file = os.path.join(os.getcwd(), 'successful_paths_pyramid1.txt')

# And data for the problem set.
passages = {         # Squares of the pyramid, floor by floor, starting from top.
            '3-3-3': ['2-3-3',], # Third floor, x-coord is 3, y-coord is 3:
                                 # maps to second floor, x-coord 3, y-coord 3.
            # Second floor now. 
            '2-2-2': ['2-2-3', '1-2-2'],                    #Two connections here.
            '2-3-2': ['1-3-2', '2-3-3', '2-4-2'],
            '2-4-2': ['1-4-2', '2-3-2', '2-4-3'],
            
            '2-2-3': ['1-2-3', '2-2-2', '2-2-4', '2-3-3'],  # Middle row.
            '2-3-3': ['3-3-3', '1-3-3', '2-2-3', '2-3-2', '2-3-4'],
            '2-4-3': ['1-4-3', '2-4-2'],
            ...
            '1-1-2': ['1-1-1', '1-2-2'],                    # Second row.
            '1-2-2': ['2-2-2', '1-2-1', '1-1-2', '1-2-3'],
            '1-3-2': ['2-3-2', '1-4-2'],
            '1-4-2': ['2-4-2', '1-3-2'],
            '1-5-2': ['1-5-1', '1-5-3'],

            '1-1-3': ['1-2-3', '1-1-4'],                    # Third row.
            '1-2-3': ['2-2-3', '1-2-2', '1-1-3', '1-2-4', '1-3-3'],
            '1-3-3': ['2-3-3', '1-2-3', '1-4-3', '1-3-4'],
            '1-4-3': ['2-4-3', '1-3-3', '1-5-3'],
            '1-5-3': ['1-4-3', '1-5-2'],

            '1-1-4': ['1-1-3', '1-2-4', '1-1-5'],           # Fourth row.
            '1-2-4': ['2-2-4', '1-1-4', '1-2-3', '1-2-5'],
            '1-3-4': ['2-3-4', '1-3-3', '1-3-5'],
            '1-4-4': ['2-4-4', '1-5-4', '1-4-5'],
            '1-5-4': ['1-4-4', '1-5-5'],

            '1-1-5': ['1-1-4', '1-2-5'],                    # Fifth and last row.
            '1-2-5': ['1-1-5', '1-2-4'],
            '1-3-5': ['1-3-4', '1-4-5'],
            '1-4-5': ['1-4-4', '1-3-5', '1-5-5'],
            '1-5-5': ['1-4-5', '1-5-4'],
}
