#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""A quick Morse code translator for Heike Borchers's *Under the Sea*, a game
entered in IFComp 2019.
...
def decode(what:str, dash_selection_procedure=is_upper) -> str:
    """Decode WHAT, returning the decoded message."""
