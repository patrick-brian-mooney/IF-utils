...
Also contains utility code needed by the TerpConnection object.
...
class TerpConnection(object):
    ...
    def __init__(self):
        ...
        assert self.story_file_location, "ERROR! Class {self.__class__.__name__} does specify a story file location!"
        assert self.inventory_answer_tag, "ERROR! Class {self.__class__.__name__} does not specify an inventory answer tag!"
